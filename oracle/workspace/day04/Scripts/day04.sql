/*중복이 없게 하는 거지 규칙을 주는 것은 아니다 객체역할.*/
...
VALUES(SEQ_STUDENT.NEXTVAL , 'ljm', '이종문', '컴퓨터', 'N', '1985-12-04', 20, 'A+');

INSERT INTO TBL_STUDENT
(STUDENT_ID, STUDENT_IDENTIFICATION, STUDENT_NAME, STUDENT_MAJOR, STUDENT_BIRTH, STUDENT_AGE, STUDENT_GRADE)
VALUES(SEQ_STUDENT.NEXTVAL , 'sch', '성춘향', '그네', '2000-12-04', 24, 'B+');
...
/*자식에서 쓰고 있으면 변경이 안된다. 이렇게 할려면 부모에 국화를 추가해줘서 사용한다.*/
UPDATE TBL_FLOWER 
SET FLOWER_NAME ='국화'
